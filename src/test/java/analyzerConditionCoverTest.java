...
public class analyzerConditionCoverTest {
    @Before
    public void before()
    {
        analyzer.init("");
    ...
    public void Digit1()
    {
        Assert.assertEquals(analyzer.main(new String[]{"1"}),"返回标识符和指针 整数,1");
    }
    @Test
    public void Digit2()
    {
        Assert.assertEquals(analyzer.main(new String[]{"111"}),"返回标识符和指针 整数,1");
    }
